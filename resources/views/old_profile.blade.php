                    ...
                    <div class="header_section shadow bg-white m-2 rounded-5">
                        <div class="pb-3 pt-1">
                            ...
                            <div class="tikl_profile_content text-center">
                                ...
                                <!--<p class="mb-0" style="{{$is_private ? 'filter:blur(3px)' : '' }}">-->
                                <!--    <strong>{{ $user->job_title ? 'Profecion: ' : '' }} </strong>{{ $user->job_title }}-->
                                        <!--{{  $user->job_title && $user->company ? '<br>' : '' }}-->
                                <!--        @if($user->job_title && $user->company)-->
                                <!--        <br>-->
                                <!--        @endif-->
                                <!--     <strong>{{ $user->company ? 'Empresa: ' : '' }} </strong>{{ $user->company }}-->
                                <!--</p>-->
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-11">
                                ...
                                <div class="about_section mt-3">
                                    ...
                                    <div class="content-container">
                                        ...
                                        <button class="btn border see-more-btn btn-grad text-white ">See More</button> --}}
                                    </div>
                                </div>
                                
                                <div class="about_section mt-3">
                                    <div class="d-flex gap-2">
                                        <h1>Profecion: </h1>{{ $user->job_title ? $user->job_title : 'N/A' }}
                                    </div>
                                    <div class="d-flex gap-2">
                                        <h1>Empresa: </h1> {{ $user->company ? $user->company : 'N/A' }}
                                    </div>
                                </div>
                                        ...
                                        <div class="social-media-links d-flex">
                                            @for ($j = 0; $j < count($userPlatforms[$i]); $j++)
                                                <div class="col-3 col-lg-3 d-flex justify-content-center">
                                                    ...
                                                    <a href="{{ $userPlatforms[$i][$j]->base_url . $userPlatforms[$i][$j]->path }}" class="social" 
                                                        style="{{ $userPlatforms[$i][$j]->check_user_privacy ? 'filter:blur(5px)' :  '' }}"
                                                        target="{{$userPlatforms[$i][$j]->check_user_privacy ? '' : '_blank'}}">
                                                        <img src="{{ asset(isImageExist($userPlatforms[$i][$j]->icon, 'platform')) }}"
                                                            class="img-fluid" />
                                    ...
                                    <div class="row my-3">
                                        ...
                                        <div class="col-10">
                                            <a href="{{ $is_private ? 'javascript:void(0)' : 'mailto:business@vittortech.com' }}" 
                                                ...
                                                <div class="contact-information" style="{{$is_private ? 'filter:blur(3px)' : '' }}">
                                                    {{ $user->email }}
                                                </div>
                                                <div>
                                                    <span>
